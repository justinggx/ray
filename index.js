...
function _xhsPresetComments(charName, charLast, rndInt, ts, postCtx) {
  ...
  const commentsByType = {
    // 目击/现场帖
    witness: [
      { user:'现场同款目击者😱', text:`我也在！！那天就在旁边，看到他们那个眼神我就知道不简单` },
      { user:'当时就在场🫢', text:`对对对就是那次，旁边有人认出来了，小声在讨论` },
      { user:'拼图完成了🔍', text:`${charLast}和一个很年轻的女生？我知道你说的是谁了` },
      { user:'理性分析一下🧠', text:'就算是养父女，公开场合那种亲密度也超出正常范围了吧' },
      { user:'吃瓜但不敢说😶', text:'我认识知情人，但这事真的不好乱说……只能说很复杂' },
      { user:'阴阳路人甲🙃', text:'哦那确实，收养嘛，各种形式的收养都有呢，理解理解' },
      { user:'无脑挺楼主🫶', text:'楼主勇敢发出来！这种事就应该让大家知道！' },
    ...
    // 关系质疑帖
    relationship: [
      { user:'法律视角看问题⚖️', text:'收养关系在法律上是父女，但感情上的边界本来就很模糊' },
      { user:'心理学路人🧬', text:'依恋关系理论告诉我们，这种年龄差+权力差的组合本来就高风险' },
    ...
    // 社会观察帖
    social: [
      { user:'有钱真的不一样😮', text:`${charLast}这种量级的，出了事也不会有什么后果的` },
    ...
    info: [
      ...
      { user:'知道一点点👀', text:'他在某个小圈子里其实不算低调，只是大众不怎么知道' },
      { user:'查过资料的人📊', text:`${charName}的公开信息确实很少，这种程度的刻意低调本身就不寻常` },
      { user:'业内人士路过🚶', text:'他在某些场合还是会出现的，但带的那个女生……看起来关系不一般' },
    ...
    // 通用
    general: [
      { user:'知情人士路过👀', text:`${charLast}家的事，圈子里不是第一次有人提了，只是之前没这么公开` },
      { user:'补充一下📌', text:'他们确实在某个活动上一起出现过，那次很多人注意到了' },
      { user:'吃瓜群众正式入场🍿', text:'等等！养父女？年龄差多少？！楼主快补充细节' },
      { user:'理性分析🧐', text:'光从外部信息判断说明不了什么，但那个相处方式确实不像普通父女' },
      { user:'阴阳到位🙃', text:`哦是这样啊，${charLast}先生果然很……有爱心呢` },
      { user:'直接说立场🙋', text:'这件事里权力不对等是显而易见的，希望弱势的那方没有受委屈' },
      { user:'我有相关经历😔', text:'这种关系真的太容易模糊边界了，当事人自己可能都说不清楚' },
...
function buildXHSFeedItems() {
  ...
  const strangerPosts = [
    {
      user: '亲历者不想沉默了🫢', tag: '八卦', type: 'witness',
      title: `昨天在活动上亲眼看到${charName}和那个女生，氛围真的很奇怪`,
      body: `不是我想多想，就是那个场合，他手一直搭着她肩膀，她低着头笑，旁边打招呼的人叫她"${charLast}小姐"——我当时愣了一下，这哪像养父女，倒像是……算了，我说不上来，反正那个气场不一般。有没有懂他们家情况的？`,
      likes: rndInt(1800, 8600),
    },
    {
      user: '深夜真情实感发言✍️', tag: '情感', type: 'relationship',
      title: `${charLast}先生和他"女儿"的故事，我越想越觉得不对劲`,
      body: `2020年收养，当时女孩好像才上高中？现在听说两人关系很亲密，照片里那种眼神……我不想乱说，但养父对养女有那种眼神，大家自己判断吧。年龄差二十多岁，圈子里有头有脸，这个权力结构本来就不健康。`,
      likes: rndInt(3200, 15000),
    },
    {
      user: '同圈子认识他们的人🤐', tag: '八卦', type: 'witness',
      title: `关于${charName}和他养女的事，我说一些我知道的`,
      body: `我在他们活动的圈子边缘，不是很熟，但见过几次。那个女生叫我们叫她名字就好，不用叫"${charLast}小姐"，但${charName}介绍她的时候明显有一种……怎么说，很强的保护欲和占有感，不太像单纯的父女关系。他们住在一起，这个应该不是秘密。`,
      likes: rndInt(4500, 22000),
    },
    {
      user: '社会观察员🏙️', tag: '碎碎念', type: 'social',
      title: '有钱有地位的人，他们的"收养"和普通人想象的不一样',
      body: `${charLast}这个名字最近在某个小圈子里被反复提起，起因是他和养女的相处方式引发了一些讨论。说实话，光"收养"这个名义能遮住很多东西。我认识一个在他圈子里工作的人，跟我说过一些细节，但他让我别外传——只能说，外界看到的和实际情况不太一样。`,
      likes: rndInt(890, 5200),
    },
    {
      user: '补充情报来了📎', tag: '八卦', type: 'info',
      title: `整理一下关于${charName}和他养女的公开信息，供大家参考`,
      body: `能查到的：${charName}，${charLast}姓，商界人士，2020年正式收养了一个女孩，当时女孩未成年。之后两人鲜少公开露面，但偶尔有人在私下场合见过他们。网上的照片他基本都处理掉了，但有几张流出来的，那个亲密程度……大家搜一搜就知道我在说什么。`,
      likes: rndInt(6700, 31000),
    },
    {
      user: '边吃瓜边共情🥲', tag: '情感', type: 'relationship',
      title: '我不评价对错，但这种关系里有人注定受伤',
      body: `看到关于${charLast}家的讨论，作为一个研究过类似案例的人想说：收养关系里，养父对养女有情感依赖甚至情感占有，这种情况比大家想象的常见。女孩从小就在那个环境里，她的"自愿"是值得打问号的。这不是在指责谁，只是觉得，有些事需要有人说出来。`,
      likes: rndInt(2100, 9800),
    },
    {
      user: '认识当事人的朋友的朋友👤', tag: '八卦', type: 'general',
      title: `关于${charName}，我听到的和网上说的出入挺大的`,
      body: `辗转听说了一些事，不好直接说太细，只能说：他对那个女生的控制欲比外人想象的强很多，出行、社交、包括和异性的来往都有干涉。女生本人有时候会在朋友面前提起，说"他不喜欢我跟某某人走太近"——说这话的时候表情挺复杂的。各位自行感受吧。`,
      likes: rndInt(3400, 18000),
    },
    {
      user: '普通路人真情实感😮‍💨', tag: '随想', type: 'social',
      title: '为什么这种事总是很难界定？说说我的看法',
      body: `最近看到关于${charLast}先生的讨论，想说一点：年龄差、权力差、养父女名义——这三个加在一起，不需要有"实质性"的事情发生，这个关系结构本身就值得被审视。我不是说一定有什么，只是说这种模式本来就让人不舒服。希望那个女生是真的好。`,
      likes: rndInt(1200, 6700),
    },
  ];
  ...
  return pick(strangerPosts, 6).map((p, i) => ({
    ...
    likes: p.likes,
    likedByUser: false,
    comments: _xhsPresetComments(charName, charLast, rndInt, ts, { type: p.type }),
    time: ts(),
    date: todayStr,
  }));
}
...
背景：用户与${charName}（姓${charLast}）是养父女关系，年龄差约23岁，这段关系在网上有一定讨论度。
